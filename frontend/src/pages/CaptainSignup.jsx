...
const CaptainSignup = () => {
  ...
  return (
    <div className='py-1 px-5 h-screen flex flex-col justify-between'>
      <div>
        <img className='w-11 mb-1' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmoJcsV2aZSkAm3nmwtyjuiekrT3H5U7pvjQ&s" alt="" />
        ...
        <form onSubmit={(e) => {
          ...
          <h3 className='text-lg font-small mb-1'>What's our Captain's email</h3>
          <input
            required
            value={email}
            onChange={(e) => {
          ...
          <h3 className='text-lg font-small mb-1'>Enter Password</h3>
          ...
          <h3 className='text-lg font-small mb-1'>Vehicle Information</h3>
          <div className='flex gap-4 mb-7'>
            <input
              required
              className='bg-[#eeeeee] w-1/2 rounded-lg px-4 py-2 border text-lg placeholder:text-base'
