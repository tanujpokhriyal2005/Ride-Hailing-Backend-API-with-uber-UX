    ...
    return (
        <div className='overflow-hidden'>
            <h5 onClick={()=>{
                ...
                <h3 className='text-xl font-semibold mb-5 p-2'>Confirm your Ride</h3>
                <div className='flex gap-2 justify-between flex-col items-center'>
                    ...
                    }} className=' mb-5 w-full bg-green-700 text-white font-semibold py-3 rounded-lg mt-4'>Confirm</button>
                </div>
        </div>
    )
}
